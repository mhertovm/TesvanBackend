...
CREATE TABLE "Blog" (
    "id" SERIAL NOT NULL,
    "metaTitle_am" VARCHAR(255),
    "metaTitle_en" VARCHAR(255),
    "metaTitle_ru" VARCHAR(255),
    "metaDescription_am" VARCHAR(255),
    "metaDescription_en" VARCHAR(255),
    "metaDescription_ru" VARCHAR(255),
    "image" VARCHAR(255) NOT NULL,
    "duration_am" VARCHAR(255),
    "duration_en" VARCHAR(255),
    "duration_ru" VARCHAR(255),
    "content_am" TEXT,
    "content_en" TEXT,
    "content_ru" TEXT,
